# usage "python kali-pi-temp.py" can use -k for monitor mode (loop refresh).
...
for index, a in enumerate(args):
        ...
        if a == "-h" or a == "--help":
                ...
                print("-t       designate in celsius how hot should be considered overheating, Default is 80")
...
# get a clean number
        cel = raw/1000
# convert our temp to fahrenheit
        far = (cel * 1.8) + 32
